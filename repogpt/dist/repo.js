...
export function zipUrl({ owner, repo, branch = 'main' }) {
...
export function summarizeZip(buffer_1, _a) {
    return __asyncGenerator(this, arguments, function* summarizeZip_1(buffer, _b) {
        var { batches, ignoredExtensions = IGNORED_EXTENSIONS } = _b, branch = __rest(_b, ["batches", "ignoredExtensions"]);
        const data = (yield __await(loadAsync(buffer))).files;
